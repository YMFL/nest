import {IsString, IsInt, IsNotEmpty, Min, Max, IsOptional, IsEmpty, IsDefined} from 'class-validator';
...
export class PageInfo {
  ...
  @Type(() => Number)
  @Min(1, {message: '参数必须大于1', context: {errorCode: ApiErrorCode.USER_PAGE_INVALID}})
  @IsInt({message: '必须是整数', context: {errorCode: ApiErrorCode.USER_PAGE_INVALID}})
